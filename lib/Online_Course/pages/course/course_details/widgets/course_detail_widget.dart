  ...
  return Container(
      ...
      decoration: BoxDecoration(
          image: DecorationImage(
              fit: BoxFit.fitWidth,
              image:
                  NetworkImage("${AppConstants.SERVER_UPLOADS}$thumbNail"))));
}
...
Widget buildListViewCourseDetails(
  ...
  var imagesInfo = <String, String>{
    ...
    "${states.courseItem!.down_num ?? "0"} Downloadable Resources":
        "download_detail.png",
  };
  return Column(
    children: [
